...
export class NestStarter1749714361073 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TABLE "email-change"
                             (
                                 "token"      character(21) NOT NULL,
                                 "newEmail"   text          NOT NULL,
                                 "userId"     integer       NOT NULL,
                                 "validUntil" TIMESTAMP     NOT NULL DEFAULT timezone('utc', now()) + interval '2 days',
                                 CONTRAINT    "PK_2257238e3438c07d1809a949765" PRIMARY KEY ("token")
                             )`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "notification" DROP CONSTRAINT "FK_301fece8cf3b510c5f79da1e3d8"`);await queryRunner.query(`ALTER TABLE "notification" DROP CONSTRAINT "FK_1ced25315eb974b73391fb1c81b"`);
